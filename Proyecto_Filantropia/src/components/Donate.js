        ...
        <div class="row">
          <div class="col-lg-8 col-md-12">
            ...
            <div class="donation-wrap">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <select class="form-control my" name="dtype">
                      <option>Selecciona el tipo de documento</option>
                      <option value="DPO">
                        Documento de identidad pais de origen
                      </option>
                      <option value="DNI">
                        Documento nacional de identidad
                      </option>
                      <option value="IN">Identificacion nacional</option>
              ...
              <h3 class="h3-sm fw-5 txt-blue mb-3 mt-3">Detalles del pago</h3>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input
          ...
          <div class="col-lg-4 col-md-12">
            <div class="faqs-sidebar pos-rel">
              ...
              <form>
                <h3 class="h3-sm fw-7 txt-white mb-3">
                ...
                <div class="form-group">
                  <label for="questionmsg">
                    <strong>Como podemos ayudarte?</strong>
                  </label>
                  <textarea
                    class="form-control form-light"
                    rows="5"
